			...
			<div class="home-page-grid">
				<section class="home-page-card">
					...
					<ul class="home-feature-list">
						<li><strong>Manage Data</strong> - Add, edit, search, sort, paginate, and bulk delete records</li>
				...
				<section class="home-page-card">
					...
					<ol class="home-step-list">
						<li>Open <strong>Data</strong> to manage records</li>
						<li>Open <strong>Audit Trail</strong> to verify changes</li>
						<li>Open <strong>Reports</strong> to generate exports</li>
						<li>Open <strong>UI Customization</strong> to set your widget view</li>
					</ol>
				</section>
			</div>
		</section>
