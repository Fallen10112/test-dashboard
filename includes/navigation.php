	...
	<nav class="sidebar">
		...
		<div class="sidebar-user">
			<?php
			$navUser = $GLOBALS['auth_user'] ?? null;
			$navDisplayName = ($navUser && $navUser['display_name'] !== null && $navUser['display_name'] !== '')
				? $navUser['display_name']
				: ($navUser['email'] ?? 'User');
			?>
			<span class="sidebar-user-name" title="<?php echo htmlspecialchars($navUser['email'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
				<?php echo htmlspecialchars($navDisplayName, ENT_QUOTES, 'UTF-8'); ?>
			</span>
